...
testingRow <- which(grepl(2017, x_mean$Year_t1))

#create training dataset
x_mean_train <- x_mean[-testingRow, ]
x_knn_train <- x_knn[-testingRow, ]
y_train <- y[-testingRow]

#create test dataset
x_mean_test<- x_mean[testingRow, ]
x_knn_test <- x_knn[testingRow, ]
y_test <- y[testingRow]

#df dataset
df_pred <- df[testingRow, ]
